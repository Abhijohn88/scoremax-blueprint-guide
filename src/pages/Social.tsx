    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-purple-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <Link to="/social" className="text-purple-600 font-medium">Social</Link>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                Master <span className="text-purple-600">History, Geography, Civics & Economics</span>
              </h1>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-600 to-purple-700">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-purple-100 text-lg mb-8">Focus on what scores. Skip what doesn't.</p>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <Link to="/social" className="block text-purple-400 font-medium">Social Blueprint</Link>
